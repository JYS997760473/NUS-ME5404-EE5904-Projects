function [RBF_train_accuracy, RBF_test_accuracy, test_predicted] = RBF(gamma, num_train, train_label, ...
    ...
    if min(eig_value_RBF) < -1e-4
        ...
        [alpha_RBF, support_vector_idx_RBF] = cal_quadprog(num_train, H_RBF, C, train_data, ...
                                                            train_label);
    ...
    test_predicted = prediction_RBF_test;
end