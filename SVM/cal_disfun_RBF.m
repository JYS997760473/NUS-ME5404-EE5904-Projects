function [kernel_support_vector, bias_mean] = cal_disfun_RBF(support_vector_idx, ...
                                                train_label, num_train, train_data, alpha, gamma)
    ...
    for i = 1: num_support_vector
        for j = 1: num_train
            kernel_support_vector(j,i) = exp(-gamma*((train_data(:,support_vector_idx(i))'...
                    -train_data(:,j)') * (train_data(:,support_vector_idx(i))-train_data(:,j))));
        end   
    end
